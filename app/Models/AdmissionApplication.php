...
#[Fillable([
    ...
    'present_village', 'present_post_office', 'present_upazila', 'present_district', 'father_mobile',
    'permanent_village_bn', 'permanent_post_office_bn', 'permanent_upazila_bn', 'permanent_district_bn', 'mother_mobile',
