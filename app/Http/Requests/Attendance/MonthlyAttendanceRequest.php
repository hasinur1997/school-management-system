...
/**
 * Validates the monthly attendance query for a student's sheet. Both month and
 * year are optional and default to the current month/year; an out-of-range
 * month (or non-integer) is a 422 validation error.
 */
